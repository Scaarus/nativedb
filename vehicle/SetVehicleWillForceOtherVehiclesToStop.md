...
```
This is used for cases where a car is parked in the middle of the road and you want traffic to queue rather than try and swerve around. NOTE: This is a reset flag and needs to be called each frame
