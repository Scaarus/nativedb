...
```c
// 0x80CA6A8B6C094CC4
bool GET_NTH_CLOSEST_VEHICLE_NODE_WITH_HEADING(Vector3 Position, int NodeNumber, Vector3 ReturnNearestNodePosition, float ReturnHeading, int ReturnNumLanes, int nodeFlags, float zMeasureMult, float zTolerance);
```
