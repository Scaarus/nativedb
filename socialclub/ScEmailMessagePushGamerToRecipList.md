...
Call this function a bunch of times to put together the list, then call an SC_EMAIL_SEND_EMAIL function.  The list is cleared each time the list is used to send a message
