...
```c
// 0xC84527E235FCA219
bool UGC_CREATE_CONTENT(ugc_paths_struct szFilePaths, int nFiles, string szDisplayName, ugc_description szDesc, ugc_description szTags, string szContentType, bool Publish, int datafileIndex);
```
